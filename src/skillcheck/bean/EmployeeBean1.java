 ...
 * 社員情報データ（モデル）
 */
public final class EmployeeBean1 {
     ...
     * @param empId
     */
    public EmployeeBean1(String empId) {
        this._empId = empId;
    }
     ...
     */
    public EmployeeBean1(String empId, String password, String name, String mail, String programingLanguage, String comment) {
        this._empId = empId;
     ...
     * @return 
     */
    public void EmployeeBean(String empId, String password, String name, String mail, String programingLanguage, String comment, String deleteFlg) {
        this._empId = empId;
        this._password = password;
        this._name = name;
        this._mail = mail;
